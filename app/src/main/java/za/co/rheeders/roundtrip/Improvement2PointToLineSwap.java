...
public class Improvement2PointToLineSwap {
    ...
    public Improvement2PointToLineSwap(ArrayList<Destination> route) {
        this.route = route;
        runImprovement();
    }
        ...
        for (TwoPointsToLine twoPointsToLine : twoPointsToLines){
            ...
            if (!(improvedDestinations.contains(twoPointsToLine.getPointA()) || improvedDestinations.contains(twoPointsToLine.getPointB()) || improvedDestinations.contains(twoPointsToLine.getPointVertexA()) || improvedDestinations.contains(twoPointsToLine.getPointVertexB()) || improvedDestinations.contains(twoPointsToLine.getLineVertexA()) || improvedDestinations.contains(twoPointsToLine.getLineVertexB()))) {
                ...
                if (isImprovementTwoPoints(twoPointsToLine)) {
                    ...
                    System.out.println(twoPointsToLine.getPointVertexA().getPlaceName() + " " + twoPointsToLine.getPointVertexB().getPlaceName() + " " + twoPointsToLine.getPointA().getPlaceName() + " " + twoPointsToLine.getPointB().getPlaceName() + " " + twoPointsToLine.getLineVertexA().getPlaceName() + " " + twoPointsToLine.getLineVertexB().getPlaceName());

                    route.remove(twoPointsToLine.getPointA());
                    route.remove(twoPointsToLine.getPointB());

                    route.add(route.indexOf(twoPointsToLine.getLineVertexB()), twoPointsToLine.getPointA());
                    route.add(route.indexOf(twoPointsToLine.getLineVertexB()), twoPointsToLine.getPointB());
